//
//  AWSQLiteDBFramework.h
//  AWSQLiteDBFramework
//
//  Created by 秦 道平 on 15/12/8.
...
//! Project version string for AWSQLiteDBFramework.
FOUNDATION_EXPORT const unsigned char AWSQLiteDBFrameworkVersionString[];
